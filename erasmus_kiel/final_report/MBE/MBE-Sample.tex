...
\title[LTSP in \textit{E. coli} and \textit{P. fluorescens}]{Long term stationary phase in \textit{Escherichia coli} and \textit{Pseudomonas fluorescens}}

\author[Gallie et al.]{Jenna \surname{Gallie},$^{1}$ Saul Pierotti,$^{1}$}

\address{$^{1}$Department of Ecology, Evolution and Behavior\\
$^{2}$Bell Museum of Natural History, University of VMinnesota, 100 Ecology, 1987 Upper Buford
...
\coresp{E-mail:gallie@evolbio.mpg.de }
